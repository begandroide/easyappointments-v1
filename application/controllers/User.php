    ...
    public function ajax_forgot_password()
    {
        try
        {
            ...
            if ($new_password != FALSE)
            {
                ...
                $this->email->from('bgautier@inf.utfsm.cl', 'Benjamin');
                $this->email->to($this->input->post('email'));
                //$this->email->cc('another@another-example.com');
                //$this->email->bcc('them@their-example.com');
                $this->email->subject('Regenerate password');
                $this->email->message('Testing the email class.'.'Tu nuevo token es :'.$new_password);
                $this->email->send();
